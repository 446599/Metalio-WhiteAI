...
public:
    // Honours the provisioning request recorded in NVS.  Blocks in the config
    // AP until the phone stores credentials and the board reboots.
    void StartProvisioningIfRequested();
