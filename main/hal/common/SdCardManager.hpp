...
// ---------------------------------------------------------------------------
// SdCardManager — 板级 SDMMC 单例（ESP32-S3，1-bit）
//
// 初始化逻辑对齐 peripheral-testing-code/esp32-s3-sdcard：
//   SDMMC_HOST_DEFAULT + SLOT_CONFIG_DEFAULT，CLK/CMD/D0，width=1，内部上拉
// 挂载点：/sdcard；应用数据统一在 /sdcard/metalio/e-ink/…
// ---------------------------------------------------------------------------
class SdCardManager {
public:
