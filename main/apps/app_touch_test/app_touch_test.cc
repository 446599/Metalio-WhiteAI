...
constexpr const char* TAG = "AppTouchTest";
constexpr const char* kScreenId = "app_touch_test";

constexpr lv_coord_t kTargetHit = 64;
constexpr lv_coord_t kRingSize = 48;
constexpr lv_coord_t kCrossLen = 56;
constexpr lv_coord_t kCrossThick = 2;
constexpr lv_coord_t kCoreSize = 10;
constexpr lv_coord_t kCoreClear = 16;
constexpr lv_coord_t kEdgeInset = 48;
constexpr lv_coord_t kBottomInset = 96;
constexpr lv_coord_t kCenterGap = 70;
...
lv_obj_t* AppTouchTest::Create() {
    ESP_LOGI(TAG, "create touch test");
    ...
    lv_label_set_text(s_start_lbl, "点击屏幕，开始测试");
    ...
    VkKey_AttachScreen(scr, kScreenId, VkKeyScreenDesc{AppTouchTest::Create});
    return scr;
}
